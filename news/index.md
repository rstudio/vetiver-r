...
- Added model monitoring dashboard template
  ...
  [`vetiver::pin_example_kc_housing_model()`](https://rstudio.github.io/vetiver-r/reference/vetiver_dashboard.md)
...
- Deprecated
  [`vetiver_pr_predict()`](https://rstudio.github.io/vetiver-r/reference/vetiver_pr_predict.md)
  in favor of using
  [`vetiver_api()`](https://rstudio.github.io/vetiver-r/reference/vetiver_api.md)
