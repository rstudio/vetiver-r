...
#> Creating new version '20260823T164104Z-eeb97'
#> Writing to pin 'cars_linear'
model_board
#> Pin board <pins_board_folder>
#> Path: '/tmp/RtmpBTHrYE/pins-1a566d3dcb05'
#> Cache size: 0
...
#>   <chr>                  <dttm>              <chr>
#> 1 20260823T164104Z-eeb97 2026-08-23 16:41:04 eeb97
# can store an renv lockfile as part of the pin:
vetiver_pin_write(model_board, v, check_renv = TRUE)
#> Replacing version '20260823T164104Z-eeb97' with
#> '20260823T164105Z-eeb97'
#> Writing to pin 'cars_linear'
```
