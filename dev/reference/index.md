...
- [`vetiver_model()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_model.md)
  [`new_vetiver_model()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_model.md)
...
- [`vetiver_pin_write()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_pin_write.md)
  [`vetiver_pin_read()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_pin_write.md)
...
- [`vetiver_api()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_api.md)
  [`vetiver_pr_post()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_api.md)
  [`vetiver_pr_docs()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_api.md)
  :
...
- [`vetiver_sm_build()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_sm_build.md)
  [`vetiver_sm_model()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_sm_build.md)
  [`vetiver_sm_endpoint()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_sm_build.md)
  : Deploy a vetiver model API to Amazon SageMaker with modular
  functions
- [`vetiver_sm_delete()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_sm_delete.md)
...
- [`vetiver_compute_metrics()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_compute_metrics.md)
...
- [`vetiver_dashboard()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_dashboard.md)
  [`get_vetiver_dashboard_pins()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_dashboard.md)
  [`pin_example_kc_housing_model()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_dashboard.md)
...
- [`api_spec()`](https://rstudio.github.io/vetiver-r/dev/reference/api_spec.md)
  [`glue_spec_summary()`](https://rstudio.github.io/vetiver-r/dev/reference/api_spec.md)
  : Update the OpenAPI specification using model metadata

- [`attach_pkgs()`](https://rstudio.github.io/vetiver-r/dev/reference/attach_pkgs.md)
  [`load_pkgs()`](https://rstudio.github.io/vetiver-r/dev/reference/attach_pkgs.md)
  : Fully attach or load packages for making model predictions

- [`handler_startup()`](https://rstudio.github.io/vetiver-r/dev/reference/handler_startup.md)
  [`handler_predict()`](https://rstudio.github.io/vetiver-r/dev/reference/handler_startup.md)
  : Model handler functions for API endpoint

- [`map_request_body()`](https://rstudio.github.io/vetiver-r/dev/reference/map_request_body.md)
  : Identify data types for each column in an input data prototype

- [`vetiver_create_description()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_create_description.md)
  [`vetiver_prepare_model()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_create_description.md)
...
- [`vetiver_ptype()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_create_ptype.md)
  [`vetiver_create_ptype()`](https://rstudio.github.io/vetiver-r/dev/reference/vetiver_create_ptype.md)
