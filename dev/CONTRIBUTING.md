...
This outlines how to propose a change to vetiver. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rstudio/vetiver-r", fork = TRUE)`.
...
Please note that the modelops project is released with a [Contributor
Code of
Conduct](https://rstudio.github.io/vetiver-r/dev/CODE_OF_CONDUCT.md). By
