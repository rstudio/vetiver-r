...
#' - create an API endpoint for it with [vetiver_pr_post()]
#'
#'
...
#' visual documentation created by [vetiver_pr_post()]. If you do this, consider
#' checking that your input data prototype has the same structure as your
#' training data (perhaps with [hardhat::scream()]) and/or simulating data to
#' avoid leaking PII via your deployed model.
#'
