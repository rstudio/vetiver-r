...
You can **version** and **share** your `vetiver_model()` by choosing a [pins](https://pins.rstudio.com/dev/) "board" for it, including a local folder, RStudio Connect, Amazon S3, and more.
